export const m = {
  ...
  Generate_Structure_Flowchart: '生成代码结构流程图',
  ...
  Are_you_sure_you_want_to_generate_comments: '您确定要生成该代码的注释吗？',
  Your_Sumbit_is_not_right:'您提交的文件形式不正确',
  ...
  Lang: '语言',
  Structure_Flowchart_as_Follows: '代码的结构流程图如下',
  Special_Commented_Code: '特殊注释的代码如下',
  Flowchart_as_Follows: '流程图如下',
  Theme: '风格',
  Reset_Code: '重置代码',
  Upload_file: '上传文件',
  monokai: 'Monokai',
