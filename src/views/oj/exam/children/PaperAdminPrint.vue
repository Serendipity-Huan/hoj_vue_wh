...
export default {
  ...
  methods: {
    updateStatus(id) {
      ...
      api.updatePaperPrintStatus(params).then((res) => {
        myMessage.success(this.$i18n.t('m.Update_Successfully'));
        this.getPaperPrint(1);
      });
    },
    getPaperPrint(page = 1) {
      let params = {
        cid: this.paperID,
        currentPage: page,
        limit: this.limit,
    ...
    downloadSubmissions(id) {
      let url = `/api/file/download-paper-print-text?id=${id}`;
